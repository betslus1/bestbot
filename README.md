...
- Отправка уведомления <bool> - Отправка сообщения о событии в Telegram
 ...
 # Статистика
 Статистика считается по методу FIFO, для этого ежеменутно запрашивается информация о завершенных сделках. Каждому трейду покупки ставится в соответствие трейд продажи и высчитывается уплаченная комиссия, прибыль. Так же доступно отображение сводной информации по каждому инструменту.
 ...
 - Системные требования: Комипьютер средней мощности
...
PS. Сервис доступен во время работы бирж. Уровень сложности выбиром торгового инструмента. Чем выше ликвидность и ниже спред, тем сложнее будет играть.
