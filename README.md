...
- Отправка уведомления <bool> - Отправка сообщения о событии в Telegram
 ...
 Недалекое будущее. Ученые научились переносить разум в информационные системы. Ваш разум был перенесен и затерялся где-то в глубинах API Тинькофф инвестиций. Теперь вы не человек, а биржевая заявка на бирже. Вас окружают трейдеры, которые хотят Вас поймать.
